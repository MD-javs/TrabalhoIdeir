...
// Tenta estabelecer uma conexão com o banco de dados utilizando os parâmetros definidos
$conexao = mysqli_connect(DB_HOST, DB_USER, DB_PASS, DB_NAME, DB_PORT);

// Verifica se a conexão foi bem-sucedida, caso contrário, exibe um erro
if (!$conexao) {
